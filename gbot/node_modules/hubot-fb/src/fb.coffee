...
class FBMessenger extends Adapter
    ...
    constructor: ->
        ...
        @page_id    = '1504573752914456'
        @app_id     = '161140604442884'
        @app_secret = '1783c28965323cbf37b9e74fee0e40a7'

        @token      = 'EAACSjnh8mQQBANVwaRzTt66VO8wezACFjKIq4sijaEJ0cHIuBDi17q68ZBXh5B6wj0Gc6BB1oqJmaE4UTzch0i22PjOeHLXZBEzzyY6v1mZAsjWTDWtckJdmfUb2ZCUwhFolcyMbsHgTpx5wZBudnyXZAplKlKuXiQh6hybwdvcsjQP8W30g0Q7tvZC9k7j16UZD'
        @vtoken     = 'VERIFY_TOKEN' or crypto.randomBytes(16).toString('hex')

        @routeURL   = '/webhook' or '/hubot/fb'
        @webhookURL = 'https://goculture.herokuapp.com' + @routeURL
    ...
    _processAttachment: (event, envelope, attachment) ->
        ...
        console.log "-----------------------"
        global.userLocations = {
          lat : event.message.attachments[0].payload.coordinates.lat
          lng : event.message.attachments[0].payload.coordinates.long
        }
        console.log userLocations

        @robot.emit "fb_richMsg_#{attachment.type}", unique_envelope, userLocations
